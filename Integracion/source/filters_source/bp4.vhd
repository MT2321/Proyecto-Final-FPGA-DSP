...
-- Generated on: 2023-01-17 17:24:47
-- -------------------------------------------------------------
...
-- Second Stopband Edge   : 0.0125
-- First Stopband Edge    : 0.0041667
-- Second Stopband Atten. : 20 dB
-- Passband Ripple        : 1 dB
-- First Passband Edge    : 0.00625
-- First Stopband Atten.  : 20 dB
-- Second Passband Edge   : 0.010417
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: bp4
----------------------------------------------------------------
ARCHITECTURE rtl OF bp4 IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT scaleconst1                    : signed(15 DOWNTO 0) := to_signed(213, 16); -- sfix16_En15
  ...
  CONSTANT coeff_a2_section1              : signed(15 DOWNTO 0) := to_signed(-32713, 16); -- sfix16_En14
  CONSTANT coeff_a3_section1              : signed(15 DOWNTO 0) := to_signed(16347, 16); -- sfix16_En14
  CONSTANT scaleconst2                    : signed(15 DOWNTO 0) := to_signed(213, 16); -- sfix16_En15
  ...
  CONSTANT coeff_a2_section2              : signed(15 DOWNTO 0) := to_signed(-32739, 16); -- sfix16_En14
  CONSTANT coeff_a3_section2              : signed(15 DOWNTO 0) := to_signed(16361, 16); -- sfix16_En14
  CONSTANT scaleconst3                    : signed(15 DOWNTO 0) := to_signed(113, 16); -- sfix16_En15
  ...
  CONSTANT coeff_a2_section3              : signed(15 DOWNTO 0) := to_signed(-32675, 16); -- sfix16_En14
  CONSTANT coeff_a3_section3              : signed(15 DOWNTO 0) := to_signed(16304, 16); -- sfix16_En14
  CONSTANT scaleconst4                    : signed(15 DOWNTO 0) := to_signed(113, 16); -- sfix16_En15
  ...
  CONSTANT coeff_a2_section4              : signed(15 DOWNTO 0) := to_signed(-32695, 16); -- sfix16_En14
  CONSTANT coeff_a3_section4              : signed(15 DOWNTO 0) := to_signed(16319, 16); -- sfix16_En14
  CONSTANT scaleconst5                    : signed(15 DOWNTO 0) := to_signed(29205, 16); -- sfix16_En15
  -- Signals
  ...
  SIGNAL scale5                           : signed(35 DOWNTO 0); -- sfix36_En30
...
BEGIN
  ...
  output_typeconvert <= resize(shift_right(scale5(34 DOWNTO 0) + ( "0" & (scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23) & NOT scale5(23))), 23), 12);
