...
-- Generated on: 2023-01-17 17:28:14
-- -------------------------------------------------------------
...
-- Second Stopband Edge   : 0.125
-- First Stopband Edge    : 0.041667
-- Second Stopband Atten. : 20 dB
-- Passband Ripple        : 1 dB
-- First Passband Edge    : 0.0625
-- First Stopband Atten.  : 20 dB
-- Second Passband Edge   : 0.10417
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: bp7
----------------------------------------------------------------
ARCHITECTURE rtl OF bp7 IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT scaleconst1                    : signed(15 DOWNTO 0) := to_signed(24031, 16); -- sfix16_En15
  CONSTANT coeff_b1_section1              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_b2_section1              : signed(15 DOWNTO 0) := to_signed(-32361, 16); -- sfix16_En14
  CONSTANT coeff_b3_section1              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_a2_section1              : signed(15 DOWNTO 0) := to_signed(-29746, 16); -- sfix16_En14
  CONSTANT coeff_a3_section1              : signed(15 DOWNTO 0) := to_signed(15391, 16); -- sfix16_En14
  CONSTANT scaleconst2                    : signed(15 DOWNTO 0) := to_signed(24031, 16); -- sfix16_En15
  CONSTANT coeff_b1_section2              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_b2_section2              : signed(15 DOWNTO 0) := to_signed(-30105, 16); -- sfix16_En14
  CONSTANT coeff_b3_section2              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_a2_section2              : signed(15 DOWNTO 0) := to_signed(-31746, 16); -- sfix16_En14
  CONSTANT coeff_a3_section2              : signed(15 DOWNTO 0) := to_signed(15875, 16); -- sfix16_En14
  CONSTANT scaleconst3                    : signed(15 DOWNTO 0) := to_signed(13051, 16); -- sfix16_En15
  CONSTANT coeff_b1_section3              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_b2_section3              : signed(15 DOWNTO 0) := to_signed(-32629, 16); -- sfix16_En14
  CONSTANT coeff_b3_section3              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_a2_section3              : signed(15 DOWNTO 0) := to_signed(-29909, 16); -- sfix16_En14
  CONSTANT coeff_a3_section3              : signed(15 DOWNTO 0) := to_signed(14064, 16); -- sfix16_En14
  CONSTANT scaleconst4                    : signed(15 DOWNTO 0) := to_signed(13051, 16); -- sfix16_En15
  CONSTANT coeff_b1_section4              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_b2_section4              : signed(15 DOWNTO 0) := to_signed(-25531, 16); -- sfix16_En14
  CONSTANT coeff_b3_section4              : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff_a2_section4              : signed(15 DOWNTO 0) := to_signed(-27190, 16); -- sfix16_En14
  CONSTANT coeff_a3_section4              : signed(15 DOWNTO 0) := to_signed(12464, 16); -- sfix16_En14
  -- Signals
